...
import stream这个方向错了.TopologyProcessor.OtaTotal;

import java.util.Properties;
import java.util.concurrent.CountDownLatch;

public class OtaStreamUtil {
    public static void otaStreams() throws Exception {
        ...
        builder.addProcessor("Process", OtaTotal::new, "Source");
        builder.addStateStore(Stores.keyValueStoreBuilder(
                Stores.inMemoryKeyValueStore("Counts"),
                Serdes.String(),
                Serdes.String()),
                "Process");
        builder.addSink("Sink", "streams-ota-output", "Process");
