...
public class MongoDBSimpleConsumer3 {
    public static void main(String args[]) {
        MongoDBSimpleConsumer3 example = new MongoDBSimpleConsumer3();
//long maxReads = Long.parseLong(args[0]);
        long maxReads = 100;
//String topic = args[1];
        String topic = "streams-clear-output6";
