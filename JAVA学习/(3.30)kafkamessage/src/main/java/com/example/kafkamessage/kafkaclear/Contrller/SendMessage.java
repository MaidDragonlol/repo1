...
import com.example.kafkamessage.kafkaclear.getdatafrommongo.DataSearchUtils;
...
public class SendMessage {
    DataSearchUtils getInstence = new DataSearchUtils();
    ...
    public String logCountStart() throws ParseException {
        ...
        return result;
    }                                                    /*示例：localhost:8080//logCountByTime*/
