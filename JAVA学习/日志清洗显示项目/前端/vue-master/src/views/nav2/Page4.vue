    ...
    export default {
        data() {
            return {
                ...
                input2: "",
                backgroundDiv: {
                    backgroundImage: "url(" + require("../../assets/dreamstime2.png") + ")"
                },
            }
        },
        mounted: function () {
        ...
        methods: {
            ...
            getList(startTimeInput, endTimeInput) {
                ...
                this.$http
                    .get("http://127.0.0.1:8090//RouteTimesByTime?startTime=" + startTime + "&endTime=" + endTime)
                    .then(response => {
                ...
                this.$http
                    .get("http://127.0.0.1:8090//RouteErroFrequncyByTime?startTime=" + startTime + "&endTime=" + endTime)
                    .then(response => {
                        this.data = response.data;
                        var yInput = [];
                        var xInput = [];
