...
public class JsonPaser {
    ...
    public static void InsertToBean(String mothod, String everyContent) {
...
/*这个进行递归运算*/
    public static String recursive(JSONObject obj, String jsonPath, int i) throws JSONException {
        ...
        if ((i + 1) == nodes.length) {
            ...
            System.out.println(everyContent);
    ...
    public static String insertConent(String content) throws Exception {
        ...
        for (String jsonPath : jsonPaths) {
            String everyContent = recursive(obj, jsonPath, 1);
            InsertToBean(mothod, everyContent);
        }
        return null;
    }
