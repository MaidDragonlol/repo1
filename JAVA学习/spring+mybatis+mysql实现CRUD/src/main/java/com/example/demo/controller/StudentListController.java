...
public class StudentListController {
    ...
    public int batchSelect(@RequestParam("list") List<StudentDomain> list) {
        return studentService.batchInsert(list);
    }

    /*批量更新*/
    @PostMapping("/UpdateAll")
    public int batchUpdate(@RequestBody List<StudentDomain> list) {
